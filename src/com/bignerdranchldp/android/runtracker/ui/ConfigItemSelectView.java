package com.bignerdranchldp.android.runtracker.ui;
...
public class ConfigItemSelectView extends LinearLayout {
	...
	private static final String BIGNERDRANCHLDP_NAMESPACE = 
			"http://schemas.android.com/apk/res/com.bignerdranchldp.android.runtracker";
	...
	private void initView(AttributeSet attrs){
		...
		if(attrs != null){
			String configTitle = attrs.getAttributeValue(BIGNERDRANCHLDP_NAMESPACE
			...
			String configDesc = attrs.getAttributeValue(BIGNERDRANCHLDP_NAMESPACE
